import type { HudRowItem } from '../config.js';
...
import {
  renderAddedDirsLine,
  renderAddedDirsPart,
  renderContextBarPart,
  renderContextValuePart,
...
export function renderRowItem(ctx: RenderContext, item: HudRowItem): string | null {
  switch (item) {
    case 'model':
